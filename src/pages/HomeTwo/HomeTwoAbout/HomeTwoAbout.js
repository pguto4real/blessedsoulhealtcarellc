               ...
               <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-12 col-md-11">
                     <div className="about-right-side pt-25 mb-30">
                        <div className="about-title mb-20">
                           <h5 className="pink-color">Core Value</h5>
                           {/* <h1>Short Story About MediDove Clinic.</h1> */}
                        </div>
                        <div className="about-text">
                           <p> Our core values guide every aspect of the care and support
                           we provide to our residents and their families.</p><br/>
                        </div>
                        <div className="about-text-list mb-40">
                           <ul>
                              <li><i className="fa fa-check"></i><span>COMPASSION</span></li>
                              <li><i className="fa fa-check"></i><span>INTEGRITY</span></li>
                              <li><i className="fa fa-check"></i><span>RESPECT</span></li>
                              <li><i className="fa fa-check"></i><span>EXCELLENCE</span></li>
                              <li><i className="fa fa-check"></i><span>COMMUNITY</span></li>
                              <li><i className="fa fa-check"></i><span>INNOVATION</span></li>
                  ...
                  <div className="col-xl-6 col-lg-12 col-md-11">
                     <div className="about-right-side pt-25 mb-30">
                        ...
                        <div className="about-text">
                           <p>  Our goal is to create a welcoming sanctuary that feels
